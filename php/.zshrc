...
PATH=$PATH:$HOME/.local/bin:$HOME/bin:~/.config/composer/vendor/bin/
PATH=~/.npm-global/bin:/usr/local/protobuf/bin:$PATH
PATH="$HOME/.symfony/bin:$PATH"

export PATH
export GOBIN="$HOME/projects/golang/bin"
export GOPATH="$HOME/projects/golang/src"
PATH="$PATH:$GOBIN"
